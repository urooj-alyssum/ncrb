...
st.set_page_config(page_title="NCRB-DATACRUX-AI", layout="wide")
...
img=get_image_as_base64("light.jpg")
ing=get_image_as_base64("above.png")
side=get_image_as_base64("sidee.jpg")

page_bg_img=f"""
<style>
  [data-testid="stAppViewContainer"]{{
  background-image: url("data:bcg/png;base64,{img}");
  background-position: center top; /* Adjusted to center top */
  ...
  background-image: url("data:bcg/png;base64,{ing}");
  ...
  background-image: url("data:bcg/png;base64,{side}");
  background-size:100% 100%;
  background-repeat : no-repeat;
  }}
</style>
...
with col2:
    st.image("my_image.jpg", caption='Powered by DataCrux', width=600)
...
# st.markdown("<p class='description'>This Generative AI dashboard allows you to ask questions and get answers from the model. Your question history will be displayed on the left-hand side.</p>", unsafe_allow_html=True)
